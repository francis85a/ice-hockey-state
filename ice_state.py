...
def main() -> None:
    ...
    canada.añadir_jugador(Jugadora(29, "Marie-Philip Poulin",  Posicion.CENTER, 1))
    canada.añadir_jugador(Jugadora(19, "Brianne Jenner",       Posicion.CENTER, 1))
    canada.añadir_jugador(Jugadora(10, "Sarah Fillier",        Posicion.CENTER, 1))
    canada.añadir_jugador(Jugadora(24, "Natalie Spooner",      Posicion.LEFTWING, 1))
    canada.añadir_jugador(Jugadora( 3, "Jocelyne Larocque",    Posicion.LEFT_DEFENSEMAN, 1))
    canada.añadir_jugador(Jugadora(35, "Ann-Renée Desbiens",   Posicion.GOALIE, 1))

    canada.listar_jugadores()

    usa = Equipo("USA")

    usa.añadir_jugador(Jugadora(21, "Hilary Knight",           Posicion.RIGHTWING, 1))
    usa.añadir_jugador(Jugadora(28, "Amanda Kessel",           Posicion.CENTER, 1))
    usa.añadir_jugador(Jugadora(26, "Kendall Coyne Schofield", Posicion.CENTER, 1))
    usa.añadir_jugador(Jugadora(25, "Alex Carpenter",          Posicion.RIGHTWING, 1))
    usa.añadir_jugador(Jugadora( 5, "Megan Keller",            Posicion.LEFT_DEFENSEMAN, 1))
    usa.añadir_jugador(Jugadora( 1, "Alex Cavallini",          Posicion.GOALIE, 1))
